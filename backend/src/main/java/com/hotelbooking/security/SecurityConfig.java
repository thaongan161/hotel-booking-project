...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .requestMatchers(HttpMethod.POST, "/api/bookings/**").hasRole("customer") // booking chỉ cho customer
                .requestMatchers(HttpMethod.PUT, "/api/rooms/**").hasRole("hotel_admin")        // sửa phòng chỉ cho admin
